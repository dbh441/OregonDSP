...
public class AnalogPrototype {
  ...
  public AnalogPrototype() {
   ...
   public AnalogPrototype lptohp( double omega0 ) {
    ...
    /**
     * Converts a lowpass analog prototype with cutoff at 1 rad/sec to a band reject filter with specified cutoffs.
     *
     * @param omega1     double containing the low cutoff frequency in radians/sec.
     * @param omega2     double containing the high cutoff frequency in radians/sec.
     * @return           AnalogPrototype object containing the transformed filter representation.
     */
    public AnalogPrototype lptobr( double omega1, double omega2 ) {
    	return lptohp( 1.0 ).lptobp( omega1, omega2 );
    }
	...
	/**
	 * Computes the transfer function representation of the filter as a product of second-order section transfer functions.
	 *
