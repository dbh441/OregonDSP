...
public class Sequence {
  ...
  /**
   * Method to alias a double precision source sequence into a destination sequence.
   * 
   * Source value src[n] is added to dst[ mod(n,dst.length) ].
   *
  ...
  /**
   * Reverses a double precision sequence in place.
   *
   * @param  y   float[] containing the sequence to be reversed.
   */
  ...
  /**
   * Removes the mean of a double precision sequence.
   *
   * @param y    float[] specifying the sequence to be demeaned.
   */
  ...
  /**
   * Performs a circular shift of a double precision sequence.
   *
  ...
  /**
   * Shifts a double precision sequence left or right and pads with zeros (unlike the circular shift, sequence values are lost).
   *
  ...
  /**
   * Decimates a double precision sequence by a specified rate.
   *
  ...
  /**
   * Stretches a double precision sequence by a specified rate.
   * 
   * This operation spreads the sequence values out and fills between them with interstitial zeros.
   * It is a basic operation needed for interpolation by an integer rate.
   *
  ...
  /**
   * Multiplies a double precision sequence by a constant.
   *
  ...
  /**
   * Pad a double precision sequence with zeros (on the right)
   * 
   * If ypadded.length < y.length, this method performs a truncation of y.
   * 
