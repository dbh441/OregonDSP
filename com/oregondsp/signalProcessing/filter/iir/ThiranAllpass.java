 ...
 * They have unit amplitude response, thus have no amplitude distortion, and approximately
...
public class ThiranAllpass extends Allpass {
   ...
   * @param D     the delay, in samples, N-1 < D < N
   */
  ...
  /**
   * constructs a degenerate Thiran allpass filter ( delay an integer )
   * 
   * @param N  int, the delay in samples
   */
  ...
  public static void main( String[] args ) {
	  ...
	  ThiranAllpass TA = new ThiranAllpass( 5, 4.9999 );
	  TA.print( System.out );
